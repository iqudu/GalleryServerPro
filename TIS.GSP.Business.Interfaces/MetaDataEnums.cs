...
namespace GalleryServerPro.Business.Metadata
{
	...
	/// </summary>
	/// <remarks>Note to developer: If you edit these items, be sure to update 
	/// <see cref="FormattedMetadataItemNameEnumHelper.IsValidFormattedMetadataItemName" /> to match your changes.</remarks>
	...
	/// <summary>
	/// Contains functionality to support the <see cref="FormattedMetadataItemName" /> enumeration.
	/// </summary>
	public static class FormattedMetadataItemNameEnumHelper
	{
		/// <summary>
