...
namespace GalleryServerPro.ErrorHandler.CustomExceptions
{
	...
	public class InvalidGalleryException : Exception
	{
		...
		/// <param name="context">The System.Runtime.Serialization.StreamingContext that contains contextual 
		/// information about the source or destination.</param>
		protected InvalidGalleryException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			: base(info, context) { }
	}
	...
	{
		[NonSerialized]
		private UnsupportedImageTypeExceptionState _state;
		...
		public GalleryServerPro.Business.Interfaces.IGalleryObject MediaObject
		{
			get
			{
				return this._state.MediaObject;
			}
		}
		...
		private struct UnsupportedImageTypeExceptionState : ISafeSerializationData
		{
			...
			void ISafeSerializationData.CompleteDeserialization(object obj)
			{
				...
				UnsupportedImageTypeException exception = (UnsupportedImageTypeException)obj;
	...
	{
		[NonSerialized]
		private UnsupportedMediaObjectTypeExceptionState _state;
		...
		{
			this._state.MediaObjectFilePath = filePath;
		...
		{
			this._state.MediaObjectFilePath = (file == null ? Resources.DefaultFilename : file.FullName);
		...
		public string MediaObjectFilePath
		{
			get
			{
				return this._state.MediaObjectFilePath;
			}
		}
		...
		private struct UnsupportedMediaObjectTypeExceptionState : ISafeSerializationData
		{
			...
			public string MediaObjectFilePath
			{
				...
				set
				{
					this._mediaObjectFilePath = value;
				}
			}
			...
			void ISafeSerializationData.CompleteDeserialization(object obj)
			{
				...
				// Since the exception simply contains an instance of the exception state object, we can repopulate it 
				// here by just setting its instance field to be equal to this deserialized state instance.
				UnsupportedMediaObjectTypeException exception = (UnsupportedMediaObjectTypeException)obj;
				exception._state = this;
			}
		}
	}
	...
	{
		[NonSerialized]
		private InvalidMediaObjectDirectoryExceptionState _state;
		...
		{
			this._state.MediaObjectPath = (mediaObjectPath ?? Resources.DefaultDirectoryPath);
		...
		public string MediaObjectPath
		{
			get
			{
				return this._state.MediaObjectPath;
			}
		}
		...
		private struct InvalidMediaObjectDirectoryExceptionState : ISafeSerializationData
		{
			...
			void ISafeSerializationData.CompleteDeserialization(object obj)
			{
				...
				// Since the exception simply contains an instance of the exception state object, we can repopulate it 
				// here by just setting its instance field to be equal to this deserialized state instance.
				InvalidMediaObjectDirectoryException exception = (InvalidMediaObjectDirectoryException)obj;
				exception._state = this;
			}
		}
	}
	...
	{
		[NonSerialized]
		private CannotWriteToDirectoryExceptionState _state;
		...
		{
			this._state.DirectoryPath = (directoryPath ?? Resources.DefaultDirectoryPath);
		...
		public string DirectoryPath
		{
			get
			{
				return this._state.DirectoryPath;
			}
		}
		...
		private struct CannotWriteToDirectoryExceptionState : ISafeSerializationData
		{
			...
			void ISafeSerializationData.CompleteDeserialization(object obj)
			{
				...
				// Since the exception simply contains an instance of the exception state object, we can repopulate it 
				// here by just setting its instance field to be equal to this deserialized state instance.
				CannotWriteToDirectoryException exception = (CannotWriteToDirectoryException)obj;
				exception._state = this;
			}
		}
	}
	...
	{
		[NonSerialized]
		private CannotReadFromDirectoryExceptionState _state;
		...
		private struct CannotReadFromDirectoryExceptionState : ISafeSerializationData
		{
			...
			void ISafeSerializationData.CompleteDeserialization(object obj)
			{
				...
				// Since the exception simply contains an instance of the exception state object, we can repopulate it 
				// here by just setting its instance field to be equal to this deserialized state instance.
				CannotReadFromDirectoryException exception = (CannotReadFromDirectoryException)obj;
				exception._state = this;
			}
		}
	}
