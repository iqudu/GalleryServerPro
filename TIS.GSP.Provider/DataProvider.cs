...
namespace GalleryServerPro.Provider
{
	...
	public abstract class DataProvider : System.Configuration.Provider.ProviderBase, Interfaces.IDataProvider
	{
		...
		/// </returns>
		public abstract IEnumerable<MediaObjectDto> Album_GetChildMediaObjectsById(int albumId);
		...
		/// </returns>
		public abstract MediaObjectDto MediaObject_GetMediaObjectById(int mediaObjectId);
